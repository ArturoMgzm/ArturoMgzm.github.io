...
public class StyleDictionaryClass {
    ...
    public static let globalColorDarkBlue100 = #333366
    public static let globalColorGray100 = #757D88
    public static let globalColorLightGray100 = #CCD2DD
    public static let globalColorPrimary100 = #4E04AF
    public static let globalColorSecondary100 = #B591F9
